...
\par
Main parameters for a simulation run are a choice of \nameref{subsec:background_sets}, a scale factor for the background images, and a random number seed, Table \ref{table:key_simulation_parameters}, Supplemental Material.
\par
