...
% \begin{figure*}
%     \includegraphics[width=0.99\textwidth,height=2in]{images/middle_gray_pixel.png}
%     \caption{TexSyn example}
%     \Description{Overview of TexSyn representation of texture.}
%     \label{fig:TexSyn_example}
% \end{figure*}
\begin{figure*}
    \includegraphics[width=0.99\textwidth,height=2in]{images/draft_texsyn_overview.png}
    \caption{TexSyn example}
    \Description{Overview of TexSyn representation of texture.}
    \label{fig:TexSyn_example}
\end{figure*}
