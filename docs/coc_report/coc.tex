...
%     \includegraphics[width=\textwidth]{images/texsyn_overview.pdf}
%     \caption{qqq.}
%     \Description{Overview of TexSyn representation of texture and the idea of crossover between expression trees.}
%     \label{fig:TexSyn_overview_qqq}
% \end{figure*}
