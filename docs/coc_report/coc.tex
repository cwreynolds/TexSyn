...
\section{Discussion}
This simulation model was applied to a variety of background sets to produce prey camouflage patterns suited to those environments. Figures \ref{fig:rock_wall_4x} to \ref{fig:yellow_flower_4x} shows examples from several runs. See Supplemental Materials for more.
...
\begin{figure*}
    ...
    \caption{Four tournament images from run rock\_wall\_20221112\_1555. Standard run parameters.}
    \Description{QQQ.}
...
\begin{figure*}
    ...
    \caption{Four tournament images from run bean\_soup\_mix\_20221231\_1317. Note: this was an “extra large” run on a hard background.}
    \Description{QQQ.}
...
\begin{figure*}
    ...
    \caption{Four tournament images from run backyard\_oak\_20230113\_2254. Note: this was an “extra large” run on a hard background.}
    \Description{QQQ.}
...
\begin{figure*}
    ...
    \caption{Four tournament images from run mbta\_flowers\_20230105\_1114. Note: this was an “extra large” run on a hard background.}
    \Description{QQQ.}
...
\begin{figure*}
    ...
    \caption{Four tournament images from run kitchen\_granite\_20230110\_1758. Standard run parameters.}
    \Description{QQQ.}
...
\begin{figure*}
    ...
    \caption{Four tournament images from run yellow\_flower\_on\_green\_20221217\_1826. Standard run parameters.}
    \Description{QQQ.}
...
The most fully detailed description of this simulation model is the source code of its reference implementation \textbf{(Note to reviewers: open source code (plus other data) will be made available if paper is accepted for publication)}. This table summarizes some of the key parameters which are used for most results shown in this paper. A few runs, where noted, were “extra large” with populations twice as large, and simulation run for twice as many steps.
\par
\hspace*{1cm}
